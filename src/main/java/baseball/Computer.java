...
public class Computer {
    ...
    private Integer getGameBall(String userInput) {
        int resultBall = 0;

        for (int i = 0; i < GameValue.CORRECT_LENGTH; i++) {
            if (computerAnswer.contains(userInput.charAt(i)) && userInput.charAt(i) != computerAnswer.get(i)) {
                resultBall++;
            }
        }
        return resultBall;
    ...
    private Integer getGameStrike(String userInput) {
        int resultStrike = 0;
